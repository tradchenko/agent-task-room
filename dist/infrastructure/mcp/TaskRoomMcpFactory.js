...
export class TaskRoomMcpFactory {
    ...
    create() {
        ...
        server.registerTool('open_task_room', {
        ...
        server.registerTool('join_task_room', {
        ...
        server.registerTool('list_task_rooms', {
            title: 'Список комнат',
        ...
        server.registerTool('search_task_rooms', {
        ...
        server.registerTool('declare_context', {
        ...
        server.registerTool('post_room_message', {
        ...
        server.registerTool('get_room_updates', {
            ...
            return makeTextResult(`Найдено ${result.updates.length} новых сообщений.`, result);
        });
        server.registerTool('get_room_history', {
            ...
            return makeTextResult(`Найдено ${result.entries.length} history entries.`, result);
        });
        server.registerTool('add_room_artifact', {
        ...
        server.registerTool('record_room_decision', {
        ...
        server.registerTool('submit_final_position', {
        ...
        server.registerTool('record_human_feedback', {
        ...
        server.registerTool('close_task_room', {
...
//# sourceMappingURL=TaskRoomMcpFactory.js.map