...
import { createRoomRepository } from '../infrastructure/persistence/RoomRepositoryFactory.js';
async function main() {
    ...
    const storageBackend = process.env.AGENT_TASK_ROOM_STORAGE_BACKEND ?? undefined;
