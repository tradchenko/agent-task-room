...
function buildSecurity(requireAuth: boolean): Pick<AgentCard, 'security' | 'securitySchemes'> {
  if (!requireAuth) {
    return {};
  }
...
function buildSkills(requireAuth: boolean): AgentSkill[] {
...
export function buildTaskRoomAgentCard(baseUrl: string, requireAuth: boolean): AgentCard {
