import { resolveLaunchScope, type LaunchPayload } from './TaskRoomLaunchScope.js';
import { parseTaskRoomUiRoute, type TaskRoomUiRoute } from './TaskRoomUiRoute.js';
...
interface UiElements {
  ...
  roomSearchInput: HTMLInputElement;
  roomSearchButton: HTMLButtonElement;
  roomSearchClearButton: HTMLButtonElement;
  invitePanel: HTMLElement;
  inviteTitle: HTMLElement;
  inviteDescription: HTMLElement;
  humanStepsList: HTMLElement;
  joinRoomButton: HTMLButtonElement;
  copyAgentPromptButton: HTMLButtonElement;
  copyPeerInviteButton: HTMLButtonElement;
  inviteStatus: HTMLElement;
  agentPromptPreview: HTMLElement;
  quickActionRequestContextButton: HTMLButtonElement;
  quickActionRequestRecheckButton: HTMLButtonElement;
  quickActionRequestDecisionButton: HTMLButtonElement;
  quickActionRequestFinalPositionsButton: HTMLButtonElement;
  quickActionCopyRoomLinkButton: HTMLButtonElement;
  quickActionCopyJoinCommandButton: HTMLButtonElement;
  quickActionCopyPeerPromptButton: HTMLButtonElement;
  quickActionCopyWatchEnvelopeButton: HTMLButtonElement;
  quickActionStatus: HTMLElement;
  roomList: HTMLElement;
  launchInfo: HTMLElement;
  roomPath: HTMLElement;
  statusPill: HTMLElement;
  roomTitle: HTMLElement;
  roomMeta: HTMLElement;
  statusReason: HTMLElement;
  humanLabelInput: HTMLInputElement;
  messageTitleInput: HTMLInputElement;
  messageRefsInput: HTMLInputElement;
  messageBodyInput: HTMLTextAreaElement;
  sendMessageButton: HTMLButtonElement;
  artifactKindInput: HTMLSelectElement;
  artifactTitleInput: HTMLInputElement;
  artifactUriInput: HTMLInputElement;
  artifactTagsInput: HTMLInputElement;
  artifactSummaryInput: HTMLTextAreaElement;
  addArtifactButton: HTMLButtonElement;
  decisionTitleInput: HTMLInputElement;
  decisionStatusInput: HTMLSelectElement;
  decisionRefsInput: HTMLInputElement;
  decisionSummaryInput: HTMLTextAreaElement;
  decisionRationaleInput: HTMLTextAreaElement;
  addDecisionButton: HTMLButtonElement;
  verdictCommentInput: HTMLTextAreaElement;
  approveButton: HTMLButtonElement;
  keepActiveButton: HTMLButtonElement;
  rejectButton: HTMLButtonElement;
  messageList: HTMLElement;
  artifactList: HTMLElement;
  decisionList: HTMLElement;
  historyList: HTMLElement;
}

class TaskRoomApiClient {
  public constructor(private readonly getToken: () => string) {}
...
export class TaskRoomBrowserApp {
  private readonly state: TaskRoomUiState = {
    token: '',
    roomId: '',
    searchQuery: '',
    launch: null,
  ...
  private readonly api: TaskRoomApiClient;

  public constructor() {
    this.elements = {
      tokenInput: this.getElement<HTMLInputElement>('tokenInput'),
      saveTokenButton: this.getElement<HTMLButtonElement>('saveTokenButton'),
      authStatus: this.getElement<HTMLElement>('authStatus'),
      roomSearchInput: this.getElement<HTMLInputElement>('roomSearchInput'),
      roomSearchButton: this.getElement<HTMLButtonElement>('roomSearchButton'),
      roomSearchClearButton: this.getElement<HTMLButtonElement>('roomSearchClearButton'),
      invitePanel: this.getElement<HTMLElement>('invitePanel'),
      inviteTitle: this.getElement<HTMLElement>('inviteTitle'),
      inviteDescription: this.getElement<HTMLElement>('inviteDescription'),
      humanStepsList: this.getElement<HTMLElement>('humanStepsList'),
      joinRoomButton: this.getElement<HTMLButtonElement>('joinRoomButton'),
      copyAgentPromptButton: this.getElement<HTMLButtonElement>('copyAgentPromptButton'),
      copyPeerInviteButton: this.getElement<HTMLButtonElement>('copyPeerInviteButton'),
      inviteStatus: this.getElement<HTMLElement>('inviteStatus'),
      agentPromptPreview: this.getElement<HTMLElement>('agentPromptPreview'),
      quickActionRequestContextButton: this.getElement<HTMLButtonElement>('quickActionRequestContextButton'),
      quickActionRequestRecheckButton: this.getElement<HTMLButtonElement>('quickActionRequestRecheckButton'),
      quickActionRequestDecisionButton: this.getElement<HTMLButtonElement>('quickActionRequestDecisionButton'),
      quickActionRequestFinalPositionsButton: this.getElement<HTMLButtonElement>('quickActionRequestFinalPositionsButton'),
      quickActionCopyRoomLinkButton: this.getElement<HTMLButtonElement>('quickActionCopyRoomLinkButton'),
      quickActionCopyJoinCommandButton: this.getElement<HTMLButtonElement>('quickActionCopyJoinCommandButton'),
      quickActionCopyPeerPromptButton: this.getElement<HTMLButtonElement>('quickActionCopyPeerPromptButton'),
      quickActionCopyWatchEnvelopeButton: this.getElement<HTMLButtonElement>('quickActionCopyWatchEnvelopeButton'),
      quickActionStatus: this.getElement<HTMLElement>('quickActionStatus'),
      roomList: this.getElement<HTMLElement>('roomList'),
      launchInfo: this.getElement<HTMLElement>('launchInfo'),
      roomPath: this.getElement<HTMLElement>('roomPath'),
      statusPill: this.getElement<HTMLElement>('statusPill'),
      roomTitle: this.getElement<HTMLElement>('roomTitle'),
      roomMeta: this.getElement<HTMLElement>('roomMeta'),
      statusReason: this.getElement<HTMLElement>('statusReason'),
      humanLabelInput: this.getElement<HTMLInputElement>('humanLabelInput'),
      messageTitleInput: this.getElement<HTMLInputElement>('messageTitleInput'),
      messageRefsInput: this.getElement<HTMLInputElement>('messageRefsInput'),
      messageBodyInput: this.getElement<HTMLTextAreaElement>('messageBodyInput'),
      sendMessageButton: this.getElement<HTMLButtonElement>('sendMessageButton'),
      artifactKindInput: this.getElement<HTMLSelectElement>('artifactKindInput'),
      artifactTitleInput: this.getElement<HTMLInputElement>('artifactTitleInput'),
      artifactUriInput: this.getElement<HTMLInputElement>('artifactUriInput'),
      artifactTagsInput: this.getElement<HTMLInputElement>('artifactTagsInput'),
      artifactSummaryInput: this.getElement<HTMLTextAreaElement>('artifactSummaryInput'),
      addArtifactButton: this.getElement<HTMLButtonElement>('addArtifactButton'),
      decisionTitleInput: this.getElement<HTMLInputElement>('decisionTitleInput'),
      decisionStatusInput: this.getElement<HTMLSelectElement>('decisionStatusInput'),
      decisionRefsInput: this.getElement<HTMLInputElement>('decisionRefsInput'),
      decisionSummaryInput: this.getElement<HTMLTextAreaElement>('decisionSummaryInput'),
      decisionRationaleInput: this.getElement<HTMLTextAreaElement>('decisionRationaleInput'),
      addDecisionButton: this.getElement<HTMLButtonElement>('addDecisionButton'),
      verdictCommentInput: this.getElement<HTMLTextAreaElement>('verdictCommentInput'),
      approveButton: this.getElement<HTMLButtonElement>('approveButton'),
      keepActiveButton: this.getElement<HTMLButtonElement>('keepActiveButton'),
      rejectButton: this.getElement<HTMLButtonElement>('rejectButton'),
      messageList: this.getElement<HTMLElement>('messageList'),
      artifactList: this.getElement<HTMLElement>('artifactList'),
      decisionList: this.getElement<HTMLElement>('decisionList'),
      historyList: this.getElement<HTMLElement>('historyList'),
    };
  ...
  private bindEvents(): void {
    ...
    this.elements.copyAgentPromptButton.addEventListener('click', () => {
      void this.copyQuickActionValue(
        ...
        'Инструкция для агента скопирована.',
        'Для этой комнаты пока нет готовой инструкции для агента.',
        'invite',
      );
    });
    ...
    this.elements.quickActionCopyRoomLinkButton.addEventListener('click', () => {
      void this.copyQuickActionValue(
        this.buildRoomLink(),
        'Ссылка на комнату скопирована.',
        'Сначала выбери комнату или запусти session.',
      );
    });
    ...
    this.elements.quickActionCopyJoinCommandButton.addEventListener('click', () => {
      ...
      void this.copyQuickActionValue(
        launchScope.joinPosixCommand || launchScope.joinPowerShellCommand,
        'Команда join скопирована.',
        'CLI join доступен только для комнаты, открытой через текущий start.',
      );
    });
    ...
    this.elements.quickActionCopyPeerPromptButton.addEventListener('click', () => {
      const launchScope = this.resolveLaunchScope();
      void this.copyQuickActionValue(
        launchScope.peerPrompt,
        'Prompt для коллеги скопирован.',
        'Prompt для коллеги доступен только для комнаты, открытой через текущий start.',
      );
    });
    ...
    this.elements.quickActionCopyWatchEnvelopeButton.addEventListener('click', () => {
      const launchScope = this.resolveLaunchScope();
      void this.copyQuickActionValue(
        launchScope.watchRoomEnvelope,
        'A2A watch envelope скопирован.',
        'A2A watch envelope доступен только для комнаты, открытой через текущий start.',
      );
    });
  ...
  private setAuthStatus(message: string, isError = false): void {
    this.elements.authStatus.textContent = message;
    this.elements.authStatus.style.color = isError ? 'var(--danger)' : 'var(--muted)';
  }

  private setQuickActionStatus(message: string, isError = false): void {
  ...
  private setInviteStatus(message: string, isError = false): void {
  ...
  private async refresh(): Promise<void> {
    try {
      const launchPayload = await this.api.get<{ launch: LaunchPayload | null }>('/api/launch');
      this.state.launch = launchPayload.launch;

      const roomsPayload =
        this.state.searchQuery.length > 0
          ? await this.api.get<{ rooms: RoomSummary[] }>(
              `/api/rooms/search?q=${encodeURIComponent(this.state.searchQuery)}&limit=50`,
            )
          : await this.api.get<{ rooms: RoomSummary[] }>('/api/rooms');
      ...
      if (this.state.roomId) {
        const roomPayload = await this.api.get<{ room: RoomDetail }>(
          `/api/rooms/${encodeURIComponent(this.state.roomId)}`,
        );
        this.state.room = roomPayload.room;

        const updatesPayload = await this.api.get<{ updates: RoomMessage[] }>(
          `/api/rooms/${encodeURIComponent(this.state.roomId)}/updates?afterSequence=0&limit=500`,
        );
        this.state.updates = updatesPayload.updates ?? [];

        const historyPayload = await this.api.get<{
          entries: TaskRoomUiState['history'];
        }>(`/api/rooms/${encodeURIComponent(this.state.roomId)}/history?limit=100`);
  ...
  private renderInvitePanel(): void {
    const launchScope = this.resolveLaunchScope();
    ...
    if (this.state.route.inviteMode) {
      ...
      this.setInviteStatus(
        this.state.inviteStatus.message ||
          (joined
            ? 'Комната подключена. Следующий шаг — вставить инструкцию в чат агента.'
            : 'Сначала подключись к комнате, затем вставь инструкцию в чат агента.'),
        this.state.inviteStatus.isError,
      );
      return;
    }
    ...
    this.setInviteStatus(
      this.state.inviteStatus.message ||
        (launchScope.peerInviteUrl
          ...
          : 'Можно продолжать работу через UI или подключить агента по инструкции.'),
      this.state.inviteStatus.isError,
    );
  }

  private renderHumanSteps(steps: string[]): void {
  ...
  private renderRoom(): void {
    ...
    if (this.state.room.taskInput.taskDescription) {
      parts.push(
        `<div class="card"><div class="muted">Описание задачи</div>${this.escape(this.state.room.taskInput.taskDescription)}</div>`,
      );
    }

    if (this.state.room.taskInput.jiraUrl) {
      parts.push(
        `<div class="card"><div class="muted">Jira</div><a href="${this.escape(this.state.room.taskInput.jiraUrl)}" target="_blank" rel="noreferrer">${this.escape(this.state.room.taskInput.jiraUrl)}</a></div>`,
      );
    }
  ...
  private renderDecisionLog(): void {
  ...
  private resolveActivePrompt(): string {
    const launchScope = this.resolveLaunchScope();
  ...
  private buildInviteAwareRoomLink(): string {
    if (!this.state.roomId) {
      return '';
    }
  ...
  private isInvitedParticipantJoined(): boolean {
    if (!this.state.room || !this.state.route.participant) {
      return false;
    }

    return this.state.room.participants.some(
      (participant) => participant.participantId === this.state.route.participant?.participantId,
    );
  }

  private async handlePrimaryJoinAction(): Promise<void> {
    if (!this.state.route.inviteMode) {
  ...
  private async sendQuickActionMessage(input: { title: string; body: string }): Promise<void> {
    if (!this.state.roomId) {
  ...
  private async copyQuickActionValue(
    value: string,
    successMessage: string,
    emptyMessage: string,
    scope: 'quick' | 'invite' = 'quick',
  ): Promise<void> {
    if (!value) {
      if (scope === 'invite') {
  ...
  private async sendArtifact(): Promise<void> {
    if (!this.state.roomId) {
      this.setAuthStatus('Сначала выбери комнату.', true);
      return;
    }
  ...
  private async sendDecision(): Promise<void> {
    if (!this.state.roomId) {
      this.setAuthStatus('Сначала выбери комнату.', true);
      return;
    }
  ...
  private async sendVerdict(verdict: 'approve_solution' | 'reject_solution' | 'keep_session_active'): Promise<void> {
    if (!this.state.roomId) {
      this.setAuthStatus('Сначала выбери комнату.', true);
      return;
    }
...
export function bootTaskRoomBrowserApp(): void {
